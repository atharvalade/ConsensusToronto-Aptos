module ecochain::marketplace {
    ...
    use ecochain::verification::{Self, get_verification_status};
    ...
    public entry fun purchase_credits(
        ...
        // Verify that the project is verified
        let status = get_verification_status(project_id);
        ...
        record_transaction(String::utf8(b"Purchase"), project_id, credits, price_per_credit, buyer_addr);
    }
    ...
    public entry fun retire_credits(
        ...
        // Record the transaction
        record_transaction(String::utf8(b"Retirement"), project_id, credits, price_per_credit, buyer_addr);
    }
